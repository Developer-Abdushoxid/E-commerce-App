...
import SumaryApi from '../common/index.js';
...
const ChangeUserRole = ({
    ...
    const updateUserRole = async() => {
         ...
         const responData = await fetchResponse.json()
         ...
         console.log("role updated", responData)
    }
  return (
    <div className='fixed top-0 bottom-0 right-0 left-0 w-full h-full z-10 flex justify-between items-center bg-slate-200 opacity-80'>
